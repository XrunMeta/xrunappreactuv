...
export function isLocalSendEnabledForUser(email: string | null | undefined): boolean {
  const LOCAL_SEND_DEV_EMAILS = ['oth-test@example.invalid', 'oth-user@example.invalid', 'oth-user@example.invalid', 'oth-user@example.invalid', 'oth-user@example.invalid', 'oth-staff@example.invalid'];
