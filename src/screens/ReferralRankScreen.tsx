...
import { View, StyleSheet, ScrollView, Text, ActivityIndicator, FlatList, TouchableOpacity, Image, RefreshControl } from 'react-native';
          ...
          {loading ? (
            ...
            <FlatList
              ...
              refreshControl={
                <RefreshControl
                  refreshing={false}
                  onRefresh={() => { if (memberId) fetchRankData(memberId); }}
                />
              }
              ListFooterComponent={
                isLoadingMore ? (
