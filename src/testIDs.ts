...
export const TID = {
  ...
  countryCodeSelect: {
    queryInput: 'country-code-select-query-input',
  },
  devDebugPanel: {
  ...
  emergencyStopDialog: {
    link: 'emergency-stop-dialog-link',
  },
  forgotPassword: {
  ...
  myInfoCloseMembershipSuccess: {
    confirm: 'my-info-close-membership-success-confirm',
  },
  myInfoEdit: {
    ...
    selectCountry: 'my-info-edit-select-country',
  },
  myInfoEmailAuth: {
    sendEmail: 'my-info-email-auth-send-email',
  },
  myInfoNotify: {
    deleteAll: 'my-info-notify-delete-all',
    open: 'my-info-notify-open',
  ...
  myInfoSettings: {
    ...
    navigate: 'my-info-settings-navigate',
    toggleEventToggle: 'my-info-settings-toggle-event-toggle',
    toggleNoticeToggle: 'my-info-settings-toggle-notice-toggle',
    togglePushToggle: 'my-info-settings-toggle-push-toggle',
  },
  myinfoShopSales: {
    applySearch: 'myinfo-shop-sales-apply-search',
    changeCalendarMonth: 'myinfo-shop-sales-change-calendar-month',
    changeCalendarMonth2: 'myinfo-shop-sales-change-calendar-month-2',
    dateInput: 'myinfo-shop-sales-date-input',
    dateInput2: 'myinfo-shop-sales-date-input-2',
  ...
  polygonWallet: {
    filter: 'polygon-wallet-filter',
  },
  referralDepthOne: {
    close: 'referral-depth-one-close',
  },
  referralDepthTwo: {
  ...
  shopItemRegister: {
    ...
    descriptionInput: 'shop-item-register-description-input',
    maxpurchaseInput: 'shop-item-register-maxpurchase-input',
    priceXrunInput: 'shop-item-register-price-xrun-input',
    submit: 'shop-item-register-submit',
    submit2: 'shop-item-register-submit-2',
    submitInput: 'shop-item-register-submit-input',
    titleInput: 'shop-item-register-title-input',
  },
  shopMyItems: {
    searchQueryInput: 'shop-my-items-search-query-input',
    useItem: 'shop-my-items-use-item',
    useItem2: 'shop-my-items-use-item-2',
    useItem3: 'shop-my-items-use-item-3',
  ...
  shopProductDetail: {
    ...
    iakSuccessClose: 'shop-product-detail-iak-success-close',
    maxAmount: 'shop-product-detail-max-amount',
    paymentSuccessClose: 'shop-product-detail-payment-success-close',
    purchase: 'shop-product-detail-purchase',
    qrScan: 'shop-product-detail-qr-scan',
    xplayAmountInput: 'shop-product-detail-xplay-amount-input',
  ...
  shopTicket: {
    searchQueryInput: 'shop-ticket-search-query-input',
    testSpend10: 'shop-ticket-test-spend10',
  },
  shopTicketDetail: {
  ...
  walletPrivateKeyDisplay: {
    ...
    toggleKeyVisibility: 'wallet-private-key-display-toggle-key-visibility',
  },
  walletPrivateKeyGoogleAuth: {
    ...
    requestBackupConsent3: 'wallet-private-key-google-auth-request-backup-consent-3',
    toggleConfirmCheck: 'wallet-private-key-google-auth-toggle-confirm-check',
  },
  walletQrScan: {
    qrScan: 'wallet-qr-scan-qr-scan',
  },
  walletReceive: {
    qrScan: 'wallet-receive-qr-scan',
  ...
  walletSend: {
    ...
    deleteAddress: 'wallet-send-delete-address',
  ...
  xplayInfo: {
    navigate: 'xplay-info-navigate',
    navigate2: 'xplay-info-navigate-2',
    navigate3: 'xplay-info-navigate-3',
    navigate4: 'xplay-info-navigate-4',
    questShare: 'xplay-info-quest-share',
  },
  xplayZone: {
    zone1: 'xplay-zone-zone1',
    zone2: 'xplay-zone-zone2',
  },
  xrunWallet: {
    filterVisible: 'xrun-wallet-filter-visible',
  },
  xrunWalletScreen2: {
    filterVisible: 'xrun-wallet-screen2-filter-visible',
  },
  xrunwalletDescription: {
    navigate: 'xrunwallet-description-navigate',
  },
} as const;
